			...
			<div class="container">
				...
				<form class="form Inquiry" method="POST" enctype="multipart/form-data" action="./Assets/Php/Index.php">
				   ...
				   <div>
					    ...
					    <div id="payments">
						    <img id="paymentImg" src="./Assets/Images/payment.png" style="width:200px;height:200px; display: inline-block; vertical-align: middle;">
						    ...
						    <button id="submitpay" type="submit" >Submit</button>
						</div>
